    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_code', models.ImageField(blank=True, upload_to='receipts/qr_codes/')),
                ('pdf_file', models.FileField(blank=True, upload_to='receipts/pdfs/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vote_type', models.CharField(choices=[('CANDIDATE', 'Candidate Vote'), ('NOTA', 'NOTA (None of the Above)'), ('INVALID', 'Invalid Vote')], max_length=20)),
                ...
                ('polling_station_id', models.CharField(blank=True, max_length=20)),
                ('ip_address', models.GenericIPAddressField(blank=True, null=True)),
